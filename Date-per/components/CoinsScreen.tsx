    ...
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={[styles.balanceCard, { backgroundColor: theme.primary }]}>
          ...
          <Text style={styles.infoText}>10 coins = 24hr chat access</Text>
          <TouchableOpacity style={styles.buyBtn}>
            <Text style={styles.buyBtnText}>+ Buy More Coins</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.quickActions}>
          <View style={[styles.quickCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
            ...
            <Text style={[styles.quickLabel, { color: theme.text }]}>Start Chat</Text>
            <Text style={[styles.quickCost, { color: theme.textSecondary }]}>10 coins</Text>
          </View>
          <View style={[styles.quickCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
            <Text style={styles.quickIcon}>⭐</Text>
            <Text style={[styles.quickLabel, { color: theme.text }]}>Super Like</Text>
            <Text style={[styles.quickCost, { color: theme.textSecondary }]}>5 coins</Text>
          </View>
          <View style={[styles.quickCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
            <Text style={styles.quickIcon}>🔥</Text>
            <Text style={[styles.quickLabel, { color: theme.text }]}>Boost</Text>
            <Text style={[styles.quickCost, { color: theme.textSecondary }]}>20 coins</Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.earnCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
            ...
            <View style={styles.earnInfo}>
              <Text style={[styles.earnTitle, { color: theme.text }]}>Daily Check-in</Text>
              <Text style={[styles.earnDesc, { color: theme.textSecondary }]}>Get 10 coins every day</Text>
            </View>
            <TouchableOpacity style={styles.earnBtn}>
              <Text style={styles.earnBtnText}>Claim</Text>
            </TouchableOpacity>
          </View>
          <View style={[styles.earnCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
            <Text style={styles.earnIcon}>👥</Text>
...
const styles = StyleSheet.create({
  ...
  balanceCard: { margin: 20, borderRadius: 24, padding: 30, alignItems: 'center' },
  ...
  balanceText: { fontSize: 20, color: '#fff', fontWeight: '600' },
  infoText: { fontSize: 13, color: 'rgba(255,255,255,0.7)', marginBottom: 16 },
  buyBtn: { backgroundColor: 'rgba(255,255,255,0.2)', paddingHorizontal: 24, paddingVertical: 12, borderRadius: 20, borderWidth: 1, borderColor: 'rgba(255,255,255,0.3)' },
  buyBtnText: { fontSize: 15, color: '#fff', fontWeight: '700' },
